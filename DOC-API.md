...
* [maze-generator-core](#module_maze-generator-core) ⇐ <code>[@mitchallen/connection-grid-core](#external_@mitchallen/connection-grid-core)</code>
    * [.openBorders(options)](#module_maze-generator-core+openBorders)
    * [.generate(options)](#module_maze-generator-core+generate) ⇒ <code>boolean</code>

<a name="module_maze-generator-core+openBorders"></a>

### maze-generator-core.openBorders(options)
Open borders after maze generation.
This method is automatically called by [generate](#module_maze-generator-core+generate) after the maze has been generated.
...
| --- | --- | --- |
| options | <code>Object</code> | Named parameters for method |
| options.spec | <code>Array</code> | Array of info on how to open each border |
